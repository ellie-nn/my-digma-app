 ...
 #       else:
  #          printout = f".{self.counter} {time.strftime('%H:%M:%S')} -1 -1 -1"
   #         sendout =  [self.counter, utime - SUB_TIME, -1, -1, -1]
        ...
        print('Fdatanamef')
        print(os.environ.get('PYTHON_SERVICE_ARGUMENT', '0.0'))
        print(int(float(os.environ.get('PYTHON_SERVICE_ARGUMENT', '0.0').split('_')[0])))
        print(int(float(os.environ.get('PYTHON_SERVICE_ARGUMENT', '0.0').split('_')[1])))
        print(int(float(os.environ.get('PYTHON_SERVICE_ARGUMENT', '0.0').split('_')[2])))
